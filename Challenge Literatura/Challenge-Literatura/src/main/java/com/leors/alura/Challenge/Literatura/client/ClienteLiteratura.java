package com.leors.alura.Challenge.Literatura.client;
...
import com.leors.alura.Challenge.Literatura.mapper.ConvierteDatos;
import com.leors.alura.Challenge.Literatura.model.Respuesta;
...
import com.leors.alura.Challenge.Literatura.service.ConsumoAPI;
...
public class ClienteLiteratura {
    ...
    private void buscarAutoresVivo() {
        ...
        List<AutorEntity> autores = autorRepositorio.findForYear(año);
